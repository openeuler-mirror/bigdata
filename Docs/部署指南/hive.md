...
|hive|3.1.3|官网获取，aarch64版本需移植，参考[hive移植指南](https://atomgit.com/openeuler/bigdata/blob/master/Docs/%E7%A7%BB%E6%A4%8D%E6%8C%87%E5%8D%97/hive.md)|
##### 1.2硬件要求
```
...
```
#### 3- 部署Hive
在部署Hive之前请先安装部署好Hadoop,参考[hadoop部署指南](https://atomgit.com/openeuler/bigdata/blob/master/Docs/%E7%A7%BB%E6%A4%8D%E6%8C%87%E5%8D%97/hadoop.md)
