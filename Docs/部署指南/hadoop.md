...
#### 3-部署 ZooKeeper
##### 3.1 编译并解压 ZooKeeper
步骤1 参考ZooKeeper移植指南“[zookeeper移植指南](https://atomgit.com/openeuler/bigdata/blob/master/Docs/%E7%A7%BB%E6%A4%8D%E6%8C%87%E5%8D%97/zookeeper.md)”编译出“zookeeper-3.8.1.tar.gz”部署包。
```
