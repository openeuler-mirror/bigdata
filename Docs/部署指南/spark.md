...
|spark|3.3.0|官网获取，aarch64版本需移植，参考[spark移植指南](https://atomgit.com/openeuler/bigdata/blob/master/Docs/%E7%A7%BB%E6%A4%8D%E6%8C%87%E5%8D%97/spark.md)|
##### 1.2硬件要求
```
...
```
#### 3- 部署Spark
在部署Hive之前请先安装部署好Hadoop,参考[hadoop部署指南](https://atomgit.com/openeuler/bigdata/blob/master/Docs/%E9%83%A8%E7%BD%B2%E6%8C%87%E5%8D%97/hadoop.md)
##### 3.1 安装Scala
```
